...
# TP Wither within 300 block radius of given coord in Overworld to x=-15 y=-65 z=-15
execute in minecraft:overworld run tp @e[type=wither,x=0,y=64,z=0,distance=..300] -15 -65 -15
...
schedule function localisedwitherremover:localisedwitherremover 100t